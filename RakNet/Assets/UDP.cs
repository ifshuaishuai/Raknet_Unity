...
public class UDP : MonoBehaviour
{
	...
	public string ip = "192.168.31.194";
	...
	void Start ()
	{
	    ...
	    comb_reliable.value = (int)PacketReliability.RELIABLE_ORDERED;
	}
    ...
    private RakNetGUID _serverGuid;

	public void SendString (string s, bool UpdateLocalTime, PacketReliability reliability)
	{
	    if(_serverGuid == null)
	        _serverGuid = client.GetGUIDFromIndex(0);

        Debug.Log(Time.frameCount);
	    Profiler.BeginSample("__send");
		client.Send (s, s.Length + 1, PacketPriority.LOW_PRIORITY, reliability, (char)0, _serverGuid, false);
	    Profiler.EndSample();
	}
